...
public class LocalhostRuntimeSupport: DeploymentProviderRuntimeSupport {
    ...
    let currentNodeCustomLaunchInfo: LocalhostLaunchInfo
    ...
    public required init(systemConfig: DeployedSystemConfiguration) {
        ...
        self.currentNodeCustomLaunchInfo = systemConfig.currentInstanceNode.readUserInfo(as: LocalhostLaunchInfo.self)!
    }
