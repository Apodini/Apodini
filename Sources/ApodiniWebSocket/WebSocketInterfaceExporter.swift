...
final class WebSocketInterfaceExporter: LegacyInterfaceExporter {
    ...
    func retrieveParameter<Type: Decodable>(_ parameter: EndpointParameter<Type>, for request: SomeInput) throws -> Type?? {
    ...
    func exportParameter<Type>(_ parameter: EndpointParameter<Type>) -> (String, WebSocketParameter) where Type: Decodable {
