...
class OpenAPIComponentsObjectBuilder {
    ...
    func buildSchema(for type: Decodable.Type) throws -> JSONSchema {
    ...
    func buildWrapperSchema(for types: [Decodable.Type], with necessities: [Necessity]) throws -> JSONSchema {
