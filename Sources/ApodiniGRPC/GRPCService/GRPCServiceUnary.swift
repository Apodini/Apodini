...
extension GRPCService {
    func createUnaryHandler(context: ConnectionContext<_GRPCInterfaceExporter>) -> (Vapor.Request) -> EventLoopFuture<Vapor.Response> {
    ...
    func exposeUnaryEndpoint(name endpoint: String, context: ConnectionContext<_GRPCInterfaceExporter>) throws {
