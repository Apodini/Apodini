...
struct ApodiniDeployerError: Swift.Error {
    let message: String
}
...
public final class ApodiniDeployer: Configuration {
    ...
    public func configure(_ app: Apodini.Application) {
        ...
        let deployExporter = ApodiniDeployerInterfaceExporter(app, self.configuration)
...
private struct ApodiniDeployerLifecycleHandler: LifecycleHandler {
    func didBoot(_ app: Application) throws {}
    
    func shutdown(_ app: Application) throws {
        app.storage.get(ApodiniDeployerInterfaceExporter.StorageKey.self)?.shutdownHTTPClient()
    }
}
...
class ApodiniDeployerInterfaceExporter: LegacyInterfaceExporter {
    struct StorageKey: Apodini.StorageKey {
        typealias Value = ApodiniDeployerInterfaceExporter
    }
    
    let app: Apodini.Application
    let exporterConfiguration: ApodiniDeployer.ExporterConfiguration
    ...
    init(_ app: Apodini.Application,
        ...
        app.lifecycle.use(ApodiniDeployerLifecycleHandler())
    }
    ...
    private func performDeploymentRelatedActions() throws {
        ...
        do {
            ...
            throw ApodiniDeployerError(message: "Unable to launch with custom config: \(error)")
        }
    }
...
// MARK: ApodiniDeployerInterfaceExporter.ExporterRequest
