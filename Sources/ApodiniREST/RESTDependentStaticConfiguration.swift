...
public protocol RESTDependentStaticConfiguration {
     ...
     */
    func configure(_ app: Application, parentConfiguration: RESTExporterConfiguration)
}
...
public struct EmptyRESTDependentStaticConfiguration: RESTDependentStaticConfiguration {
    public func configure(_ app: Application, parentConfiguration: RESTExporterConfiguration) { }
