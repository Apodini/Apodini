...
class LocalhostDeploymentProviderTests: ApodiniDeployerTestCase {
    ...
    func testLocalhostDeploymentProvider() throws { // swiftlint:disable:this function_body_length
        ...
        task = ChildProcess(
            executableUrl: Self.urlOfBuildProduct(named: "LocalhostDeploymentProvider"),
            arguments: [srcRoot.path, "--product-name", Self.ApodiniDeployerTestWebServiceTargetName],
            captureOutput: true,
