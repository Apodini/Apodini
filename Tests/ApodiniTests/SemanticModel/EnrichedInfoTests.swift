...
class EnrichedInfoTests: ApodiniTests {
    ...
    func testEnrichedInfoIsEquatable() throws {
        ...
        let stringType1 = EnrichedInfo(typeInfo: try typeInfo(of: String.self), propertyInfo: nil, propertiesOffset: nil)
        ...
        let complexTypePropertyInfo = EnrichedInfo(typeInfo: complexReflectedTypeProperty, propertyInfo: complexReflectedType.properties[0], propertiesOffset: 0, cardinality: .exactlyOne)
        let complexTypePropertyInfo1 = EnrichedInfo(typeInfo: complexReflectedTypeProperty, propertyInfo: nil, propertiesOffset: 0, cardinality: .exactlyOne)
        let complexTypePropertyInfo2 = EnrichedInfo(typeInfo: complexReflectedTypeProperty, propertyInfo: complexReflectedType.properties[0], propertiesOffset: 1, cardinality: .exactlyOne)
        let complexTypePropertyInfo3 = EnrichedInfo(typeInfo: complexReflectedTypeProperty, propertyInfo: complexReflectedType.properties[0], propertiesOffset: 0, cardinality: .zeroToOne)
