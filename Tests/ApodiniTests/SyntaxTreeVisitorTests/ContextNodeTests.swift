...
extension IntModifier: HandlerModifier where ModifiedComponent: Handler {
...
extension OptionalIntModifier: HandlerModifier where ModifiedComponent: Handler {
    typealias Response = ModifiedComponent.Response
}
...
extension IntAdditionModifier: HandlerModifier where ModifiedComponent: Handler {
    typealias Response = ModifiedComponent.Response
}
